...
lib/argon2/.built: $(MODULES_TARGETS)
	@echo "BUILD   argon2 (using system library)"
	@mkdir -p lib/argon2/include lib/argon2/lib
	@ln -sf /usr/include/argon2.h lib/argon2/include/
	@ln -sf /usr/lib/x86_64-linux-gnu/libargon2.so lib/argon2/lib/ 2>/dev/null || true
	@ln -sf /usr/lib/x86_64-linux-gnu/libargon2.a lib/argon2/lib/ 2>/dev/null || true
	@touch $@
